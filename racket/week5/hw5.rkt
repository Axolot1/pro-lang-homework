  ...
  (cond [(var? e) 
        ...
        [(call? e)
         (letrec ([clo (eval-under-env (call-funexp e) env)]
           ...
           (if (closure? clo)
               (letrec ([fn (closure-fun clo)]
                        [fn-env (closure-env clo)]
                        [fn-name (fun-nameopt fn)]
                        [fn-formal (fun-formal fn)]
                        [fn-body (fun-body fn)]
                        [fn-env-name (cons (cons fn-name clo) fn-env)]
                        [formal-act-pair (cons fn-formal (eval-under-env act env))])
                 (if fn-name
                     (eval-under-env fn-body (cons formal-act-pair fn-env-name))
                     (eval-under-env fn-body (cons formal-act-pair fn-env))))
