...
# should evaluate to Point.new(2.5,1.5)
a = Intersect.new(LineSegment.new(0.0,0.0,2.5,1.5),Line.new(1.0,-1.0))
b = Intersect.new(LineSegment.new(2.0,1.0,3.0,2.0), a)
c = Intersect.new(Point.new(2.5,1.5), b)

a = Line.new(5.0,0.0).intersect(LineSegment.new(1.0,5.0,2.0,2.0)) 
# k = Intersect.new(Point.new(2.5,1.5),
# 			Intersect.new(LineSegment.new(2.0,1.0,3.0,2.0),
# 				Intersect.new(LineSegment.new(0.0,0.0,2.5,1.5),Line.new(1.0,-1.0))))